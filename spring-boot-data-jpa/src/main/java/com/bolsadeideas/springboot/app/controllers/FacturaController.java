...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id,
		...
		if(factura == null) {
			flash.addFlashAttribute("error", "La factura no se encuentra en la BBDD");
	...
	public String eliminar(@PathVariable(value="id") Long id, RedirectAttributes flash) {
		...
		if(factura != null) {
			...
			flash.addAttribute("success", "Factura eliminada");
			return "redirect:/ver/" + factura.getCliente().getId();
		}
		
		flash.addFlashAttribute("error","La factura no existe en la base de datos asi que no se pudo eliminar");
		return "redirect:/listar"; 
